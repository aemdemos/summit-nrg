...
### Carry-Forward
- [ ] Fix block JS to handle DA content structure (images in `<p>` tags, different row structures)
- [ ] OR: Ensure DA-authored content matches import script's HTML structure
- [ ] Phase 2: Image hosting fixes (#22, #29)
- [ ] Phase 3: Header search icon (#16)
- [ ] Phase 4: Footer fixes (#23, #25, #24, #30)
- [ ] Phase 5: Polish (#27, #28)
- [ ] Open PR for phase1-updates branch
